...
function CronBuilder_slicedToArray(arr, i) { return CronBuilder_arrayWithHoles(arr) || CronBuilder_iterableToArrayLimit(arr, i) || CronBuilder_unsupportedIterableToArray(arr, i) || CronBuilder_nonIterableRest(); }

function CronBuilder_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function CronBuilder_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return CronBuilder_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return CronBuilder_arrayLikeToArray(o, minLen); }

function CronBuilder_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function CronBuilder_iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function CronBuilder_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function CronBuilder(_ref) {
  ...
  var _useState = Object(external_react_["useState"])(job.job.command),
      _useState2 = CronBuilder_slicedToArray(_useState, 2),
      command = _useState2[0],
      setCommand = _useState2[1];

  var _useState3 = Object(external_react_["useState"])(job.job.comment),
      _useState4 = CronBuilder_slicedToArray(_useState3, 2),
      name = _useState4[0],
      setName = _useState4[1];

  var _useState5 = Object(external_react_["useState"])(job.job.minute),
      _useState6 = CronBuilder_slicedToArray(_useState5, 2),
      minute = _useState6[0],
      setMinute = _useState6[1];

  var _useState7 = Object(external_react_["useState"])(job.job.hour),
      _useState8 = CronBuilder_slicedToArray(_useState7, 2),
      hour = _useState8[0],
      setHour = _useState8[1];

  var _useState9 = Object(external_react_["useState"])(job.job.dom),
      _useState10 = CronBuilder_slicedToArray(_useState9, 2),
      day = _useState10[0],
      setDay = _useState10[1];

  var _useState11 = Object(external_react_["useState"])(job.job.month),
      _useState12 = CronBuilder_slicedToArray(_useState11, 2),
      month = _useState12[0],
      setMonth = _useState12[1];

  var _useState13 = Object(external_react_["useState"])(job.job.dow),
      _useState14 = CronBuilder_slicedToArray(_useState13, 2),
      weekday = _useState14[0],
      setWeekday = _useState14[1];

  var _useState15 = Object(external_react_["useState"])(job.key ? 'custom' : 'minutely'),
      _useState16 = CronBuilder_slicedToArray(_useState15, 2),
