...
module.exports = __webpack_require__("uHOX");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return serialiseJob; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return placeholder; });
...
const getJobs = async reset => {
  ...
  return jobs.map(job => {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* serialiseJob */ "d"])(job);
  });
};
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  try {
    await Object(_utils_crontab__WEBPACK_IMPORTED_MODULE_0__[/* deleteJob */ "a"])(key);
    const jobs = await Object(_utils_crontab__WEBPACK_IMPORTED_MODULE_0__[/* getJobs */ "b"])();
    res.json(jobs);
  } catch (e) {
    res.json([]);
  }
