...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  try {
    const jobs = await Object(_utils_crontab__WEBPACK_IMPORTED_MODULE_0__[/* getQueue */ "c"])();
    res.statusCode = 200;
    res.json(jobs.map(j => Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_1__[/* serialiseJob */ "d"])(j)));
  } catch (error) {
    res.statusCode = 500;
    res.json({
      error: error.message
